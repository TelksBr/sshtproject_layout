      ...
      <div className="max-w-md mx-auto p-2 md:p-6 w-full">
        ...
        <div className="grid gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <div className="card p-4 md:p-6 flex flex-col items-center text-center bg-[#1a1624]/80 border border-[#8b5cf6]/20 rounded-2xl shadow-lg">
            ...
            <p className="text-[#b7abc9]/80 text-xs md:text-sm">Receba novidades, avisos e promoções no nosso canal oficial do Telegram.</p>
            <div className="flex flex-col gap-2 mt-4 w-full">
              <button
          ...
          <div className="card p-4 md:p-6 flex flex-col items-center text-center bg-[#1a1624]/80 border border-[#8b5cf6]/20 rounded-2xl shadow-lg">
            ...
            <p className="text-[#b7abc9]/80 text-xs md:text-sm">Fale diretamente com nossa equipe de suporte.</p>
            <div className="flex flex-col gap-2 mt-4 w-full">
              <button
