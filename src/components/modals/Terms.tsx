    ...
    <Modal onClose={onClose} allowClose={accepted} title="Termos de Uso" icon={FileText}>
      <div className="relative flex-1 p-4">
        <header className="flex items-center gap-3 mb-6">
          <div className="w-12 h-12 rounded-full bg-[#1a1624] flex items-center justify-center">
            <FileText className="w-6 h-6 text-[#b7abc9]" />
          </div>
        </header>
        {accepted && (
        ...
        <div className="p-4 rounded-lg bg-[#1a1624] border border-[#8b5cf6]/20">
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">1. Definição do Serviço</h2>
              <p className="text-[#b7abc9]/80 mb-4">
              ...
              <p className="text-[#b7abc9]/80 mb-4">Nosso serviço foca em:</p>
              <ul className="list-disc list-inside text-[#b7abc9]/80 space-y-2">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">2. Uso do Serviço</h2>
              <p className="text-[#b7abc9]/80 mb-4">O usuário deve utilizar o SSH T Project de forma responsável e de acordo com as leis locais. Estão proibidos:</p>
              <ul className="list-disc list-inside text-[#b7abc9]/80 space-y-2">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">3. Responsabilidade do Usuário</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">4. Limitação de Uso</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">5. Disponibilidade e Garantias</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">6. Modificações no Serviço</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">7. Reembolso e Compra de Logins</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">8. Alterações nos Termos de Uso</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <section className="mb-6">
              <h2 className="text-lg font-medium text-[#b7abc9] mb-4">9. Contato</h2>
              <p className="text-[#b7abc9]/80 mb-4">
            ...
            <footer className="mt-8 pt-4 border-t border-[#8b5cf6]/20">
              <p className="text-sm text-[#b7abc9]/60 text-center">
        ...
        <div className="mt-4 sticky bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-[#1a1624]/0 via-[#1a1624] to-[#1a1624]">
          {!accepted && (
            <button
              onClick={handleAccept}
              className="w-full h-12 rounded-xl font-medium flex items-center justify-center gap-2 bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-white hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-[#8b5cf6]/20"
            >
