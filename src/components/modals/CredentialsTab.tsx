                    ...
                    <div className="flex gap-1.5 flex-shrink-0 flex-wrap justify-end">
                      ...
                      {hasSSH && (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-2 bg-orange-600/20 hover:bg-orange-600/40 rounded-lg transition-colors active:scale-95 text-xs font-semibold text-orange-300"
