        ...
        <header className="flex items-center gap-3 mb-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-[#1a1624] flex items-center justify-center">
              <Wifi className="w-6 h-6 text-[#b7abc9]" />
            </div>
            <div>
              <p className="text-sm text-[#b7abc9]/70">Compartilhe sua conexão VPN</p>
            </div>
          </div>
        </header>
        ...
        <div className="grid gap-4">
          <div className="p-4 rounded-lg glass-effect">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                {isEnabled ? (
                  ...
                  <WifiOff className="w-5 h-5 text-[#8b5cf6]" />
                )}
              ...
              <button
                ...
                disabled={loading}
                className={`
                  px-4 min-h-[44px] rounded-full font-medium text-sm transition-colors duration-200 touch-manipulation
                  ${isEnabled 
                    ? 'bg-red-500/20 text-red-300 hover:bg-red-500/30 border border-red-500/30' 
                    : 'bg-[#8b5cf6] text-[#b7abc9] hover:bg-[#8b5cf6]/90 border border-[#8b5cf6]/50'
                  }
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-[#14111c]/50 border border-[#8b5cf6]/20">
                <Settings className="w-5 h-5 text-[#8b5cf6] mt-1" />
                <div>
                  <h3 className="text-[#b7abc9] font-medium mb-2">Configuração</h3>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-[#14111c]/50 border border-[#8b5cf6]/20">
                <Bell className="w-5 h-5 text-[#8b5cf6] mt-1" />
                <div>
                  <h3 className="text-[#b7abc9] font-medium mb-2">Informações de Conexão</h3>
                  <p className="text-sm text-[#b7abc9]/70">
